...
ADVICE: dict[str, tuple[str, str]] = {
    ...
    "loss_free": (
        "Потери мяча без давления (простые ошибки)",
        "Установка: в свободные моменты играть проще и на партнёра под ноги, а не «на удачу»; "
        "перед приёмом смотреть, где соперник, и заранее решать, куда отдавать. Сигнал «время» — "
        "партнёр кричит, что можно держать мяч.",
    ),
    "loss_pressed": (
        "Потери мяча под прессингом",
        "Установка: у владельца всегда два ближних варианта для передачи (треугольник); при "
        "прессинге — первая передача в одно касание, не держать мяч. Ближайший партнёр "
        "предлагается сразу, до приёма.",
    ),
    "fade_window": (
        "Провалы владения по времени",
        "Расстановка ротаций: заранее назначить смены до отрезков, где мяч терялся чаще всего; "
        "на этих отрезках упростить игру и вернуть мяч через вратаря и опорного.",
    ),
    "pressed_window": (
        "Отрезки сильного давления соперника",
        "Установка: на этих отрезках раньше показываться под передачу, не принимать мяч в "
        "тесноте, чаще играть в одно касание и через фланг.",
    ),
    "spread_window": (
        "Растянутость команды",
        "Установка: держать дистанцию между игроками не больше ~2 шагов от ближайшего партнёра; "
        "при потере мяча ближайшие двое сжимаются к мячу, остальные подтягиваются.",
    ),
}
